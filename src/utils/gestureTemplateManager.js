...
export function createDefaultTemplates() {
  ...
  // Normalized coordinates (0-1 scale) for shorthand characters
  const templates = {
    'a': [
      [
        { x: 0.3, y: 0.7 }, { x: 0.5, y: 0.2 }, { x: 0.7, y: 0.7 },
    ...
    'l': [
      [
        { x: 0.3, y: 0.2 }, { x: 0.3, y: 0.8 }, { x: 0.7, y: 0.8 }
      ]
    ],
    'o': [
      [
        { x: 0.5, y: 0.2 }, { x: 0.8, y: 0.35 }, { x: 0.8, y: 0.65 },
        { x: 0.5, y: 0.8 }, { x: 0.2, y: 0.65 }, { x: 0.2, y: 0.35 },
        { x: 0.5, y: 0.2 }
      ]
    ],
    's': [
      [
        { x: 0.8, y: 0.2 }, { x: 0.2, y: 0.2 }, { x: 0.2, y: 0.5 },
        { x: 0.8, y: 0.5 }, { x: 0.8, y: 0.8 }, { x: 0.2, y: 0.8 }
      ]
    ],
    't': [
      [
        { x: 0.2, y: 0.2 }, { x: 0.8, y: 0.2 }, { x: 0.5, y: 0.2 }, { x: 0.5, y: 0.8 }
      ]
    ]
  };
